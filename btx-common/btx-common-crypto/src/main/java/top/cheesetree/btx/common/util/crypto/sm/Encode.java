 ...
 * @version 1.0
 * @Description TODO
 * @date 创建时间：Jun 18, 2019 2:47:36 PM
 * @since
 */
public class Encode {
    /**
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        byte[] aa = "中国中国 ad 阿瑟大事大厦大厦大师阿瑟大事大厦".getBytes("UTF-8");
        String hex = encodeHexString(aa);
        System.out.println(hex);
        System.out.println(new String(decodeHex(hex)));
    }
}
